...
{
    /// <summary>
    /// Summary description for GetOneProductPhoto
    /// </summary>
    public class GetOneProductPhoto : IHttpHandler
    {
        ...
        public void ProcessRequest(HttpContext context)
        {
            ...
            {
                productImage = productManager.getProductImage(context.Request.QueryString["id"]);

                //convert byte to memorystream
                //store in image so i can scale the image      
                ////binary write to response
                MemoryStream ms = new MemoryStream(productImage.ProductImageData);
